...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	/** para permitir requisiçoes 
	 * de multiplas fontes tem q liberar explicitamente
	 * @return
	 */
	@Bean
	...
	/** Algoritmo de encode p/ injetar 
	 * em qualquer classe do sistema
	 * @return
	 */
	@Bean
	...
	/**o spring busca a implementação da 
	 * interface que é a UserDetailsServiceImpl 
	 * essa instancia indica qual a classe 
	 * quem é capaz de buscar o usuario por email*/
	@Override
